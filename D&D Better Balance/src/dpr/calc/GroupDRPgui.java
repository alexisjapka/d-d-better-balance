...
public class GroupDRPgui {
	...
	private void initialize() {
		...
		frmGroupDprCalculator.setBounds(100, 100, 528, 443);
		...
		tabbedPane.setBounds(10, 11, 366, 346);
		...
		pc1XB.setBounds(204, 248, 131, 23);
		pcTab1.add(pc1XB);
		...
		pc1IB.setBounds(204, 284, 131, 23);
		pcTab1.add(pc1IB);
		...
		pc2IB.setBounds(204, 284, 131, 23);
		pcTab2.add(pc2IB);
		...
		pc2XB.setBounds(204, 248, 131, 23);
		pcTab2.add(pc2XB);
		...
		pc3IB.setBounds(204, 284, 131, 23);
		pcTab3.add(pc3IB);
		...
		pc3XB.setBounds(204, 248, 131, 23);
		pcTab3.add(pc3XB);
		...
		pc4IB.setBounds(204, 284, 131, 23);
		pcTab4.add(pc4IB);
		...
		pc4XB.setBounds(204, 248, 131, 23);
		pcTab4.add(pc4XB);
		
		JLabel lblNewLabel = new JLabel("Group DPR");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setBounds(358, 33, 179, 28);
		...
		groupDPR.setBounds(404, 61, 86, 20);
		...
		lblPcDpr.setBounds(358, 92, 179, 28);
		...
		pc2DPR.setBounds(404, 180, 86, 20);
		...
		lblPcDpr_2.setBounds(358, 211, 179, 28);
		...
		pc3DPR.setBounds(404, 239, 86, 20);
		...
		lblPcDpr_3.setBounds(358, 270, 179, 28);
		...
		pc4DPR.setBounds(404, 299, 86, 20);
		frmGroupDprCalculator.getContentPane().add(pc4DPR);
		
		JButton calculate = new JButton("Calculate");
		calculate.setFont(new Font("Tahoma", Font.PLAIN, 11));
		calculate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(DPRCalc.isNumeric(tac.getText()) != true) {
					errorCheckPC1++;
					errorCheckPC2++;
					errorCheckPC3++;
					errorCheckPC4++;
					tac.setText("No Target AC Entered");
				}
				else {
					PC1.targetArmorClass = Double.parseDouble(tac.getText());
					PC2.targetArmorClass = Double.parseDouble(tac.getText());
					PC3.targetArmorClass = Double.parseDouble(tac.getText());
					PC4.targetArmorClass = Double.parseDouble(tac.getText());
				}
		...
		calculate.setBounds(404, 340, 86, 28);
		frmGroupDprCalculator.getContentPane().add(calculate);
		
		JLabel lblNewLabel_2_3_4_1 = new JLabel("Target AC");
		lblNewLabel_2_3_4_1.setBounds(20, 371, 169, 14);
		frmGroupDprCalculator.getContentPane().add(lblNewLabel_2_3_4_1);
		
		tac = new JTextField();
		tac.setColumns(10);
		tac.setBounds(217, 368, 131, 20);
		frmGroupDprCalculator.getContentPane().add(tac);
	}
}
